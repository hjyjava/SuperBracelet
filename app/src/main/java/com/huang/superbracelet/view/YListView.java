package com.huang.superbracelet.view;
...
public class YListView extends ListView implements OnScrollListener {
	...
	public void mremoveFooterView(List list, int size) {
		// TODO Auto-generated method stub
		if (list.size() < size) {
			mremoveFooterView();
		}
