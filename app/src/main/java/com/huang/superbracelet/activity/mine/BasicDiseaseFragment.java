 ...
 */
public class BasicDiseaseFragment extends BaseFragment{
    ...
    public static BasicDiseaseFragment newInstance() {
        BasicDiseaseFragment fragment = new BasicDiseaseFragment();
        return fragment;
    }
